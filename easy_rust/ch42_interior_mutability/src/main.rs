...
struct Employee {
    ...
    join_date: Date,
    salary: Cell<f64>,
    phone_number: RefCell<u64>,
    designation: Mutex<Designation>,
}
impl Employee {
    fn new(
        name: String,
        ...
        Employee {
            name,
            join_date,
            salary: Cell::new(salary),
            phone_number: RefCell::new(phone_number),
            designation: Mutex::new(designation),
        }
    }
}
fn main() {
    ...
    println!("{:#?}", employee);
    employee.salary.set(5000.50);
    println!("{:#?}", employee);
    employee.phone_number.replace(8_999_999_999);
    println!("{:#?}", employee);
    employee.phone_number.replace_with(|prev_number| {
        if *prev_number == 8_999_999_999 {
            7_999_999_999
        } else {
            9_999_999_999
        }
    ...
    println!("{:#?}", employee);
    // let mut mutex_changer = employee.designation.lock().unwrap();
    // *mutex_changer = Designation::Manager;
    // println!("{:#?}", employee);
    // drop(mutex_changer);
    // println!("{:#?}", employee);

    println!("{:#?}", employee);
    *employee.designation.lock().unwrap() = Designation::AndroidDeveloper;
    println!("{:#?}", employee);
}
